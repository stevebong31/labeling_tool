...
class App(QMainWindow):
    ...
    def init_App(self):
        ...
        # ==============================================================
        openAction = QAction(QIcon('../../../Desktop/MMMIL/CE/2차(2019년~)/labeling/ui/img/open.png'), 'Open', self)
        ...
        # ==============================================================
        saveAction = QAction(QIcon('../../../Desktop/MMMIL/CE/2차(2019년~)/labeling/ui/img/save.png'), 'Save', self)
        ...
        # ==============================================================
        exitAction = QAction(QIcon('../../../Desktop/MMMIL/CE/2차(2019년~)/labeling/ui/img/exit.png'), 'Exit', self)
